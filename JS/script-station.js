...
$(document).ready(function () {
    ...
    $("#herta").click(
        function () {
            ...
            $("#herta-img").css('display', 'block');

            $("#belobog-img").css('display', 'none');

            $("#luofu-img").css('display', 'none');
            var imageUrl = "/IMG/station-herta/background-herta.png";
    ...
    $("#jarilo").click(
        function () {
            ...
            $("#herta-img").css('display', 'none');

            $("#belobog-img").css('display', 'block');
    ...
    $("#luofu").click(
        function () {
            ...
            $("#luofu-img").css('display', 'block');
            var imageUrl = "../IMG/station-Xianzhou-Luofu/background-luofu.png";
            $("html").css("background-image", "url(" + imageUrl + ")");
